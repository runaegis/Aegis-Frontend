...
import { parsePrivateCredentialFields } from '@/lib/connectorCredentials';
...
export function ConnectorCredentialsModal({
  ...
  const fields = useMemo(() => parsePrivateCredentialFields(connectorKey, catalogItem), [connectorKey, catalogItem]);
